...
public:
    ...
    , m_group_index(group_index)
  {
    ...
    for (int i=0;i<2;++i)
    {
    	...
    	m_outputpubs_v[i] = nh.subscribe<easyfly::output>(msg_name,10,boost::bind(&CrazyflieROS::outputCallback, this, _1, i));
...
private:
  ...
  std::vector<ros::Publisher> m_outputpubs_v;
