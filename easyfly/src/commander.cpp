...
************************/
	void Move_oneCfOutward(int index, float Desti_Radius)
	{
		...
		{	
			isHovering = true;
			m_ctrl_v[index].posctrl_msg.pos_sp.x = m_hover_pos[index](0);
			m_ctrl_v[index].posctrl_msg.pos_sp.y = m_hover_pos[index](1);
			m_ctrl_v[index].posctrl_msg.pos_sp.z = m_hover_pos[index](2);
		}	
	}
/*************************************
...
/**************************************
 Move all cfs to destination position
***************************************/
	void MoveAllCfToPt(int index, Vector3f* Destination)
	{
